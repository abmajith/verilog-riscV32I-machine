...
intellectual academics and open-source material, I wrote a short description on the page Short 
 <a href="https://github.com/abmajith/verilog-riscV32I-machine?tab=readme-ov-file" class="custom-link">Notes on Von-Neuman Architecture</a>
(Von Neuman Architecture, pronounced as F'n-Noy-mon) if it helps. 
